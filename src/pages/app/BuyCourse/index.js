				...
				<div className="card p-4 m-4 d-flex justify-content-center">
					<div className="row">
						<div className="col-md-4">
							<img src={course.image_url} alt="cerebrum dummy" className="image-fluid w-100" />
						</div>
						<div className="col-md-8">
							<div className="d-flex flex-column justify-content-between">
								<div className="">
									<h1 className="text-bold mt-md-3" style={{ fontWeight: "600" }}>
										{course.name}
									</h1>
								...
								<div className="mt-5">
									<small className="btn btn-warning text-light">{priceId.lifeTime > 0 ? `N ${priceId.lifeTime}` : (priceId.lifeTime = "FREE")}</small>
								</div>
							</div>
						</div>
					</div>
					<div className="d-flex justify-content-end">
						{priceId.lifeTime > 0 && buy ? (
							<button className="btn btn-primary pull-right" onClick={handleBuy}>
								Buy Course
							</button>
						) : (
							<button className="btn btn-primary pull-right" onClick={watchCourse}>
								Watch Course
							</button>
						)}
					</div>
