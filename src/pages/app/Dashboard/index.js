...
import { dashboardImg, dashImg, ellipsesvg1, ellipsesvg2 } from "../../../assets/images";
					...
					<div className="row card p-5 shadow">
						<div className="col-12 d-flex align-items-center">
							<div className="col-8 m-5 justify-content-between">
								...
								<article>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs.</article>
							</div>
							<div className="col-4">
								<img src={dashImg} className="img-responsive bg-warning rounded-circle shadow img-fluid" alt="Cerebrum" />
							</div>
						</div>
					</div>
				</div>
					...
					<div className="col-md-6 metrics d-flex flex-wrap flex-column">
						<div className="card p-4 h-60 shadow mb-3 col-offset-6">
							<div className="row">
								<div className="col-md-6">
									<div>
										<h1 style={{ fontSize: "60px", fontWeight: "600" }} className="text-primary">
											300k
										</h1>
