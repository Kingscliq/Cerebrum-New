...
function ViewCategories() {
  ...
  const getCoursesInCategory = async (e) => {
    ...
    axios(
      `https://cerebrum-v1.herokuapp.com/api/category/course/${targetCategory}`
    ).then((res) => {
    ...
    <>
      ...
      <main className="container my-3 d-flex flex-row justify-content-between vh-100">
        ...
        <section className="col-lg-8 col-md-7">
          <section>
            <h1 className="h4 fw-700 animate__animated animate__zoomIn">
              {currentCategory}
            </h1>
                ...
                seeCourses.map((course) => (
                  ...
                  >
                    ...
                    <div className="w-100">
                      ...
                      >
                        <p className="fw-bold signup-p mx-4 my-3">
                          {course.name}
                        </p>
                      </a>
                    </div>
