...
function ViewCourse() {
  ...
  useEffect(() => {
    axios(
      "https://cerebrum-v1.herokuapp.com/api/course/view/6013cea0515bac00154c51f0"
      ...
      <main className="viewcourse-section container my-5">
        ...
        <section className="row">
                ...
                {sectionToggle == "About Course" ? (
                  <>
                    ...
                    <p>
                      ...
                      Quae ipsa perferendis aliquam repellat, vel ex sit cumque
                      reiciendis, neque doloribus sint eum voluptatem adipisci
                      nemo dolore harum praesentium laboriosam et.
                    </p>
                  </>
                ) : (
                  <>
          ...
          <aside className="col-5">
            <ViewCourseElement
              data-video-url={
                "https://res.cloudinary.com/codeangelic/video/upload/v1611911011/cerebrum/lessons/iwoo9u5n6hpwf22q9plb.mp4"
              }
              onClick={handleClick}
            />
            <ViewCourseElement
              data-video-url={"https://youtu.be/9WC5baL5CrQ"}
              onClick={handleClick}
            />
            <ViewCourseElement
              data-video-url={
