          ...
          <section className="col-lg-7 col-md-12 col-sm-12">
            ...
            <div className="w-100 shadow-lg">
              <div className="shadow bg-white rounded d-flex flex-row w-100 mt-2 mb-1">
                <Button
                  className={`btn w-50 text-center p-3 ${
                    numToggle === 0 ? "add-border-bottom" : ""
                  }`}
                  text="About Course"
              ...
              <div>
                {numToggle === 1 ? (
                  <form className="d-flex flex-column watchcourse-form">
                    <textarea
                      className="mt-3 mb-3 rounded watchcourse-textarea p-2"
                      placeholder="Type here"
                      rows="10"
                    />
                    <div className="mb-5 d-flex justify-content-end">
                      <div className="d-inline-block m-1">
                        <button className="btn watchcourse-cancel-btn">
                          Cancel
                        </button>
                      </div>

                      <div className="d-inline-block m-1">
                        <button className="btn watchcourse-send-btn">
                          Send
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <p className="signup-p">
                      Looking to Learn Product Design, but dont know where to
                      start? Get to know the basic principles of Design in this
                      fun and comprehensive course. <br />
                      <br />
                      Join Osita Ikeme, an illustrator and a Product Design
                      known for his iconic design style and analog approach to
                      design thinking, for an introduction to Product design
                      that goes beyond creating beautiful designs and walk
                      cycles to inspire the design in you.
                      <br />
                      <br />
                      Osita’s holistic approach to design will help you
                      understand the foundational principles of effective design
                      in addition to the technical skills every designer needs
                      to know. From understanding contrast and emphasis to an
                      organized design process, you’ll follow along with every
                      step of Osita’s tried and true process, creating a dancing
                      character as you go. <br />
                      <br />
                    </p>
                  </div>
                )}
