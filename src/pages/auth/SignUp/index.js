	...
	return (
		<main className="container-fluid vh-100 signup-section">
			<section className="row h-100">
					...
					<div className="card shadow w-c">
						<form onSubmit={handleSubmit}>
							...
							<Input
								...
								disabled={loading}
							/>
							<p className="signup-p">Use 8 or more characters with a mix of letters, number & symbols</p>
							<Button className="btn btn-primary w-100" text={"Sign Up"} loadingIcon={loading && <Loader />} disabled={loading} />
							<p className="signup-p pt-2">
								By signing up, you agree to our <span>Terms of Use</span> &<span>Privacy Policy.</span>
							</p>
							<hr />
				...
				<div className="col-6 bg-danger h-100 signup-image" style={{ background: `url(${loginImage})` }}></div>
			</section>
		</main>
	);
}
