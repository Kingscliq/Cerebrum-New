...
function VerifyEmail() {
	...
	const resendEmail = (e) => {
		...
		axios
			.post(`https://cerebrum-v1.herokuapp.com/api/auth/request-email-verification/?email=${email}`)
			.then((res) => {
					...
					<div className="card shadow w-c">
						<form>
							...
							<p className="mt-4 mb-3 signup-p">
								...
								<br />
								Kindly check your email @ {email} and click on the verifiction link to complete your registration. <br />
							</p>
							<hr />
