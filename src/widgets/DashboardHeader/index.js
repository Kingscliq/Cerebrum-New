			...
			<nav className="dash-nav-container container d-xl-flex justify-content-between">
				...
				<div className="dash-nav-items d-flex align-items-center">
					...
					<form onSubmit={handleSubmit}>
						<Input className="mb-5" placeholder="Search" icon={<FaSearch />} onChange={handleChange} value={search} />
					</form>
					<span id="dash-bell">
						<FaRegBell />
					</span>
					<div className="dash-user-icon d-flex">
						<span id="dash-toggle">
							<img src={dashAvater} alt="dash-avatar" className="dashimage" height="30" width="30" />
							<select
								name="dash-toogler"
								id="dash-toogler"
								onChange={(e) => {
								...
								<option value="0" className="toggle-options toggle-options-menu"></option>
